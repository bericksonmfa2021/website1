...
```{r strategy_2, cache=TRUE}

# Generate portfolio with 1.14% volatility based on maximizing longterm geometrical return

wealthplot2 <- returns_wide  %>%
  mutate(
  portfolio_growth = (0.40819 * SP500) + (0.00000 * FTSE100) + (0.2982 * FTSE250) + (3.86664 * TBOND) + (LEND * 4.57304) + (GOLD * 0),
...
geom_line() +
  ggtitle("1.14% Daily Volatility Kelly Portfolio vs. S&P500") +
  xlab("") +
  ylab("") +
  scale_y_log10(labels=scales::dollar_format()) +
  scale_color_manual(labels = c("1.14% Daily Volatility \nKelly Portfolio", "S&P500"), values = c("blueviolet", "coral2")) +
  theme_minimal() +
  theme(
